...
class NeuronConfig:
    ...
    def __init__(self, **kwargs) -> None:
        ...
        # SVD-Flash
        self.compress_ratio =  kwargs.pop("compress_ratio", 0.8)
        ...
        self.cp_degree = kwargs.pop("cp_degree", 1) #CP Degree（Communication Parallel Degree）：通信并行度，指设备之间需要同步/通信的分组大小；
        ...
        self.world_size = kwargs.pop("world_size", None) #总设备数
