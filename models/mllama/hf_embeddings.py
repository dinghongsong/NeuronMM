...
class PrecomputedAspectRatioEmbedding(nn.Module):
    def __init__(self, config: InferenceConfig, is_gated: bool = True):
        super().__init__()
        self.max_num_tiles = config.max_num_tiles
        self.hidden_size = config.hidden_size
        self.max_aspect_ratio_id = len(config.supported_aspect_ratios)
...
class PrecomputedPositionEmbedding(nn.Module):
